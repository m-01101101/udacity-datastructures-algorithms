...
A linked list, takes this one step further, the elements are not just stored in order but linked to one another (think of a paper chain). A linked list is an extension of a list and is not an array.
