...
"""
`Map` objects have two properties you will want to use to implement A* search:
intersections
    represented as a dictionary with [x, y] coordinates
roads
    a list where, if `i` is an intersection, 
